...
namespace ClassWeb.Model
{
    public class DAL
    {
        ...
        private static string ReadOnlyConnectionString = "Server=localhost;Database=classweb;Uid=root;Pwd=";
        private static string EditOnlyConnectionString = "Server=localhost;Database=classweb;Uid=root;Pwd=";
