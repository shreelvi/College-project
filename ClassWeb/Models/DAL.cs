...
namespace ClassWeb.Model
{
    public class DAL
    {
        ...
        //private static string EditOnlyConnectionString = "Server=MYSQL7003.site4now.net;Database=db_a458d6_shreelv;Uid=a458d6_shreelv;Pwd=x129y190;";
         private static string ReadOnlyConnectionString = "Server=localhost;Database=sapkgane;Uid=root;Pwd=root;";
         private static string EditOnlyConnectionString = "Server=localhost;Database=sapkgane;Uid=root;Pwd=root;";
