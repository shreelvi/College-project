...
--
/*!50003 DROP PROCEDURE IF EXISTS `sprocSaltGetFromUserID` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sprocSaltGetFromUserID`(
IN UserID INT 
)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `sprocUsersGet` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = cp850 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sprocUsersGet`(
IN UserID INT 
)
BEGIN
SELECT * FROM Users
...
-- Dump completed on 2019-03-08 20:28:57
